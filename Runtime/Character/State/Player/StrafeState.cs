...
{
    public sealed class StrafeState : BaseState<CharacterAgent>
    {
        public StrafeState(CharacterAgent controller) : base(controller) {}
        public override void OnEnter()
        {
            Debug.Log("Entering Strafe Locomotion");
        }
